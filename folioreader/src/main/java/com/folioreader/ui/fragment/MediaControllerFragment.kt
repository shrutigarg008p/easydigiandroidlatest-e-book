...
import com.folioreader.ui.view.FolioWebView.Companion.KEY
...
class MediaControllerFragment : BottomSheetDialogFragment(), TextToSpeech.OnInitListener {
...
//                Toast.makeText(activity, "Language not supported",
...
//                btnSpeak!!.isEnabled = true
            ...
            Toast.makeText(context, "TTS Initilization Failed", Toast.LENGTH_LONG)
                    .show()
