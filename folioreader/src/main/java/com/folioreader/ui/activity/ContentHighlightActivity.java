...
public class ContentHighlightActivity extends AppCompatActivity {
    ...
    private TextView btn_highlights,btn_contents;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       btn_highlights = findViewById(R.id.btn_highlights);
    ...
    private void initViews() {
        if (mConfig.isShowTts()== true){
            btn_contents.setText("Contents");
            btn_highlights.setText("Highlights");
        }
        else {
            btn_contents.setText("Innehåll");
            btn_highlights.setText("Markeringar");
        }
        ...
        btn_highlights.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
