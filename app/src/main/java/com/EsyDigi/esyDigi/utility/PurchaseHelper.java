...
public class PurchaseHelper {
    ...
    private boolean isSubscriptionSupported() {
        @SuppressLint("WrongConstant") int responseCode = mBillingClient.isFeatureSupported(SkuType.SUBS);
    ...
    private boolean isInAppSupported() {
        @SuppressLint("WrongConstant") int responseCode = mBillingClient.isFeatureSupported(SkuType.INAPP);
        if (responseCode != BillingResponse.OK)
    ...
    public void gotoManageSubscription() {
        ...
        Log.d(TAG, "gotoManageSubscription: " + "com.EsyDigi.esyDigi");

        Intent browserIntent = new Intent(Intent.ACTION_VIEW,
                Uri.parse("https://play.google.com/store/account/subscriptions?package="+"com.frida.esyDigi"));
