...
public class Util {
   ...
   /* public static boolean isPasswordLengthCorrect(TextView textViewPassword, String error) {
    ...
    public static boolean isEmailValid(TextView textView) {
        ...
        if (email.length() > 0) {
            ...
            {
                textView.setError("Please enter Valid Email Id");
                view_final = textView;
                isValid = false;
            }
        }
  ...
  /*  public static boolean checkMobileValidation(TextView txtView, String error) {
        if (txtView.length() > Constants.MOBILE_NUMBER_MAX_LENGTH || txtView.length() < Constants.MOBILE_NUMBER_MAX_LENGTH) {
            txtView.setError(error);
            view_final = txtView;
            return false;
        }
